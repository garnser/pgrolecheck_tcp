...
License:        MIT
URL:            https://github.com/garnser/pgrolecheck_tcp
...
%description
pgrolecheck is a service that checks whether a PostgreSQL server is running as a primary server or a standby replica.
